...

{
    year: "2023 - Present",
    role: "Crew Trainer",
    company: "Bukan Kedai Burger",
    type: "Part-time",
    description:
      "Led and trained cafe crew members while supporting daily operations and delivering quality customer experiences in a university cafe setting.",
  },

  {
    ...
    type: "Part-time",
    description:
      "Developed communication, teamwork, and problem-solving skills while working in a fast-paced customer service environment.",
  },
];
