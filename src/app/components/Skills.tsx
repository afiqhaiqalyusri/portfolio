...
const skillGroups = [
...

  {
    ...
    skills: [
      ...
      { name: "UI/UX", icon: "figma", level: 4 },
      { name: "Responsive Design", icon: "css3", level: 5 },
    ],
  },
...

  {
    ...
    skills: [
      ...
      { name: "VS Code", icon: "visualstudiocode", level: 5 },
    ],
  },
];
...
const achievements = [
  ...
  {
    emoji: "🌟",
    title: "Code It! Coding Tournament ",
    org: "2nd Runner up",
    year: "2023",
  },
...
// ── Spoken languages ───────────────────────────────────────────────────────────
const languages = [
  { flag: "🇲🇾", code: "MY", name: "Melayu", level: "Native", pct: 100 },
    ...
    >
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-x-24 gap-y-4 mb-16">
          ...
          >
            A curated set of frontend, UI/UX, and development tools used to craft modern
